...
/*
	RedRudeBoy
	@License: privative, pending to pay, the website was down for a long time
...
dw_scrollObj.prototype.buildScrollControls = function(id, axis, eType, bScrollbar, bAtt) {
	...
	buttonContainer = dw_Util.addElement('div', pr + 'btn_container', 'btn_container', atts);

	barStart = dw_Util.addElement('div', pr + start_cls, start_cls, atts);
	barEnd = dw_Util.addElement('div', pr + end_cls, end_cls, atts);

	buttonContainer.appendChild(barStart);
	buttonContainer.appendChild(barEnd);
	f.appendChild(buttonContainer);
